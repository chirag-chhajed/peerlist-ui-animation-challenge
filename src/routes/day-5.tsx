...
import img1 from "@/assets/skilled-fingers.svg";
import img2 from "@/assets/vibrant-vibes.svg";
    ...
    <div className="h-screen flex items-center justify-center p-1">
      ...
      >
        ...
        <Tabs
          ...
          className={"mt-4 [--light-gray:#f0f0f0] [--dark-gray:#838383]"}
        >
          <TabList className={"flex gap-2"} aria-label="Collectible View">
            <Tab
              className={
                "flex group  items-center gap-1 bg-(--light-gray) text-(--dark-gray) rounded-full selected:bg-[#00b3ff] selected:text-white px-2.5 py-1.5 cursor-pointer disabled:cursor-default transition-all duration-200 ease-in"
              }
              id="list-view"
            >
              <svg
                ...
                className="group-selected:*:fill-white *:fill-[#838383]"
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
            ...
            >
              ...
              <span className="text-sm font-medium">Pack View</span>
            </Tab>
          </TabList>
          <hr className="my-4" />
          <TabPanel className={"space-y-2 text-sm"} id="list-view">
            <div className="flex items-center gap-2">
              ...
              <div className="flex-1">
                <motion.h3 layoutId="heading-1" className="font-medium">
                  Skilled Fingers Series
                </motion.h3>
                <motion.span layoutId="price-1" className="font-medium">
                  <span>0.855</span>{" "}
                  <span className="uppercase text-(--dark-gray)">ETH</span>
                </motion.span>
              </div>
              <motion.div
                layoutId="hello-1"
              ...
              >
                ...
                <span className="uppercase text-(--dark-gray) font-medium">
                  #209
                </span>
              </motion.div>
            </div>
            <div className="flex items-center gap-2">
              ...
              />
              <div className="flex-1">
                <motion.h3 layoutId="heading-2" className="font-medium">
                  Vibrant Vibes Series
                </motion.h3>
                <motion.span layoutId="price-2" className="font-medium">
                  <span>0.209</span>{" "}
                  <span className="uppercase text-(--dark-gray)">ETH</span>
                </motion.span>
              </div>
          ...
          <TabPanel
            className={"flex text-sm justify-between font-medium"}
            id="card-view"
          >
          ...
          <TabPanel className={"mt-8 font-medium text-sm"} id="pack-view">
            <div className="space-y-4">
              <div className="relative size-22 mx-auto">
                <motion.img
                  className="size-22 absolute -rotate-12 origin-center rounded-[20px]"
                  src={img1}
                  alt="skilled fingers series"
                  layoutId="image-1"
                />
